...
class ControllerPaymentSmart2payFinnishbanks extends Controller {
    /**
     * Index action
    ...
    protected function index() {
        ...
        $this->load->model('payment/smart2pay_finnishbanks');
        ...
        $this->data['checkout_method_id'] = $this->model_payment_smart2pay_finnishbanks->getMethodId();
