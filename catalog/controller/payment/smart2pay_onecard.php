...
class ControllerPaymentSmart2payOnecard extends Controller {
    /**
     * Index action
    ...
    protected function index() {
        ...
        $this->load->model('payment/smart2pay_onecard');
        ...
        $this->data['checkout_method_id'] = $this->model_payment_smart2pay_onecard->getMethodId();
