...
class ControllerPaymentSmart2payPrzelewy24 extends Controller {
    /**
     * Index action
    ...
    protected function index() {
        ...
        $this->load->model('payment/smart2pay_przelewy24');
        ...
        $this->data['checkout_method_id'] = $this->model_payment_smart2pay_przelewy24->getMethodId();
