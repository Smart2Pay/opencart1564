...
class ControllerPaymentSmart2payUkash extends Controller {
    /**
     * Index action
    ...
    protected function index() {
        ...
        $this->load->model('payment/smart2pay_ukash');
        ...
        $this->data['checkout_method_id'] = $this->model_payment_smart2pay_ukash->getMethodId();
