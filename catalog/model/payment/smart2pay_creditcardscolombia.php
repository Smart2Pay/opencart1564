...
class ModelPaymentSmart2payCreditcardscolombia extends Model {

    static $methodName = "creditcardscolombia";
    static $displayName = "Credit Cards Colombia";
    static $methodID   = 1019;
