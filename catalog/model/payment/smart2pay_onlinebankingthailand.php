...
class ModelPaymentSmart2payOnlinebankingthailand extends Model {

    static $methodName = "onlinebankingthailand";
    static $displayName = "Online Banking Thailand";
    static $methodID   = 1037;
